                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a href="cetak.php" class="btn btn-outline-danger" target="_blank"
                                        style="text-decoration:none; margin-right: 0.5rem; ">CETAK</a>

                                    <a target="_blank" href="export_excel.php" class="btn btn-outline-success "
                                        style="text-decoration:none; margin-right: 0.5rem;">EXPORT KE
                                        EXCEL</a>

                                    <a href="import_excel.php" class="btn btn-outline-secondary"
                                        style="text-decoration:none; margin-right: 0.5rem;">IMPORT DATA DARI
                                        EXCEL</a>
                                ...
                                <tbody>
                                    ...
                                    while ($d = mysqli_fetch_array($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id_buku=<?php echo $d['id_buku']; ?>" name="id_user"
